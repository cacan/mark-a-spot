...
- Create a database and import app/config/sql/mas.sql/
...
- Open database.php.default and create db-connect.Rename.
...
- Login with admin@markaspot.org:test123 for Sysadmin Access
- Change Password /(subdirectory)/users
- Deactivate scaffolding in users_controller
