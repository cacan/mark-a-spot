 ...
 */
	function testStripTags() {
		$string = '<h2>Headline</h2>
		<?php echo $this->element('ajaxlist_element'); ?>
<p><a href="http://example.com">My Link</a> could go to a bad site</p>';
		...
		$string = '<h2>Important</h2>
		<?php echo $this->element('ajaxlist_element'); ?>
<p>Additional information here <a href="/about"><img src="/img/test.png" /></a>. Read even more here</p>';
...
<p>Additional information here <a href="/about"><img src="/img/test.png" /></a>. Read even more here</p>';
		...
		$string = '<h2 onclick="alert(\'evil\'); onmouseover="badness()">Important</h2>
		<?php echo $this->element('ajaxlist_element'); ?>
<p>Additional information here <a href="/about"><img src="/img/test.png" /></a>. Read even more here</p>';
		$expected = 'Important<p>Additional information here . Read even more here</p>';
		$result = Sanitize::stripTags($string, 'h2', 'a', 'img');
