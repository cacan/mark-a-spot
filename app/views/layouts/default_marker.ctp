...
<?php
	...
	echo '	</div>';
?>
	<div id="home_app"><a href="http://www.mark-a-spot.de" title="<?php __('Back to start') ?>"><span><?php __('Home') ?></span></a></div>
</div>
<hr class="hidden"/>
<?php    
...
<div id="footer_app">
	...
	<div class="footer_inner right">
		...
		<ul>
			<li><?php echo $markerSum.' '.$html->link(__('Markers', true),array('controller' => 'markers', 'action' => 'view', 'id' => $markerLast['Marker']['id']),array('title'=>__('Jump to latest marker', true)));?></li>
			<li><?php echo $commentSum.' '.$html->link(__('Comments', true),array('controller' => 'markers', 'action' => 'view', 'id' => $commentLast['Marker']['id']), array('title' =>__('Jump to latest comment', true)));?></li>
			<li><?php echo $ratingSum.' '.$html->link(__('Ratings', true),array('controller' => 'markers', 'action' => 'view', 'id' => $ratingLast['Rating']['model_id']),array('title'=>__('Jump to latest rated marker', true)));?></li>
		</ul>
		<h3 class="hidden"><?php __('Software:') ?></h3>
		<ul class="software">
			<li><!-- please keep the following attribution --><a id="mas" href="http://www.mark-a-spot.org"><span>Mark-a-Spot </span></a> Version <a href="https://github.com/markaspot/mark-a-spot/tree/"><span><?php echo $software;?></span></a></li>
		</ul>
	</div>
</div>
</body>
