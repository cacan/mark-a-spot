<div class="processcats index">
<h2><?php __('Processcats');?></h2>
...
?>
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action' => 'view', $processcat['Processcat']['id'])); ?>
			<?php echo $html->link(__('Edit', true), array('action' => 'edit', $processcat['Processcat']['id'])); ?>
			<?php echo $html->link(__('Delete', true), array('action' => 'delete', $processcat['Processcat']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $processcat['Processcat']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
</table>
