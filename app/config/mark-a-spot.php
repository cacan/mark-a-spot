...
$config['Site.domain'] = 'dev.markaspot.de';
$config['Site.admin.name'] = 'info@markaspot.de';
$config['Site.e-mail'] = 'info@markaspot.de';
$config['Site.name'] = 'Platzhalter Seitenname www.markaspot.de';

$config['e-mail.subject'] = 'Willkommen bei Mark-a-Spot / Musterstadt';
$config['e-mail.add.subject'] = 'Ihr Hinweis bei Mark-a-Spot / Musterstadt';
$config['e-mail.admin.subject'] = 'Ihr Hinweis bei Mark-a-Spot / Musterstadt';
$config['e-mail.resetpw.subject'] = 'Passwort Reset bei Mark-a-Spot / Musterstadt';
